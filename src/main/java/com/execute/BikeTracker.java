...
/**
 * 此类中只统计了历史上单车变动的数据，本意是想做单车活跃性分析，但是因为没有
 * 统计单车在空白的时间到底是超出统计区还是没动，无法做。
 * 
 * 此类应该可以实现的是对于单车迁移的分析。例如，某一站点有哪些单车
 * ，追踪这些单车，分析出该站点迁出单车的地点
 * @author daniel
 *
 */
@Component
public class BikeTracker {
	...
	private String file=DEFAULT_FILE+"track.txt";
...
//		System.out.println(statis);
	...
	public void produceBikeTackFile() {
		...
		String file=DEFAULT_FILE+"track.txt";
	...
	public void analyze() {
		...
		Map<String, List<LnglatTime>> data=MapperUtil.readMapListData(file, LnglatTime.class);
